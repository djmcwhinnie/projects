...
let checkTablet = window.matchMedia(
    "screen and (min-width: 768px) and (max-width: 1199px)"
);
let checkDesktop = window.matchMedia("screen and (min-width: 1200px)");
let appID = // Open Weather API Key goes here;
    ...
    function success(position) {
        ...
        fetch(url)
            ...
            .then((data) => {
                ...
                document.getElementById("tempValue").textContent = Math.floor(
                    data.main.temp
                );
                ...
                if (checkMobile.matches) {
                    document.getElementById(
                        ...
                        'linear-gradient(to right top, rgba(0,0,0,0.7) 50%, rgba(0,0,0,0.3)), url("https://source.unsplash.com/800x800/?' +
                        bkgndTerm +
                        '")';
                    console.log("this is a mobile screen");
                }
                ...
                if (checkTablet.matches) {
                    document.getElementById(
                        ...
                        'linear-gradient(to right top, rgba(0,0,0,0.7) 50%, rgba(0,0,0,0.3)), url("https://source.unsplash.com/1024x768/?' +
                        bkgndTerm +
                        '")';
                    console.log("this is a tablet screen");
                }
                ...
                if (checkDesktop.matches) {
                    document.getElementById(
                        ...
                        'linear-gradient(to right top, rgba(0,0,0,0.7) 50%, rgba(0,0,0,0.3)), url("https://source.unsplash.com/1400x1024/?' +
                        bkgndTerm +
                        '")';
                    console.log("this is a desktop screen");
                }
    ...
    weatherPromise
        ...
        .then((data) => {
            if (data.cod == 200) {
                ...
                status.textContent =
                    "Sorry, input field is blank. You need to enter a city or town name.";
            }
        })
        .catch(handleError);
